<template>
  <div class="Chord">
    ...
    <ul>
      ...
      <li>1645：阳光感，大调，（褐色回忆/林荫小路）第二个6可以改为一个七和弦</li>
      <li>1 6m7 4 5sus</li>
      <li>1625：《风吹麦浪》</li>
      ...
      <li>1325：雪夜山谷，温馨感</li>
      <li>251进行：大调Dm G C 小调 Ddim G Cm ，可以三全音替代 Dmin7 G7 Cmaj7 小调：Dmin7 Db7 Cmaj7</li>
      <li>1314451 C-Em-C-F-F-G7-C：整活的空耳旋律抽取的和弦进行，《甘美风来》</li>
    </ul>
    <h2>小调系列</h2>
    <ul>
      ...
      <li>6415 641(sus2)5：悲伤感小调（暗夜花火），事实上，好多的较为悲伤的歌曲都使用了这个和弦进行</li>
      <li>6415：《杀破狼》</li>
      ...
      <li>4566：《晚夜微雨问海棠》视频教程里看的小调常用和弦进行，结束的时候就F-> G-> Am</li>
      <li>4565(最好升成D调)：（遗憾的惆怅）一个老外教的，要把第三音向上翻阅八度</li>
      <li>3456(最好升成F#调)：（温馨中带有惆怅）一个老外教的，要把第三音向上翻阅八度，然后第一个和弦和最后一个和弦的最高音塞满全部</li>
      <li>6524(最好降成Bb调)：（凄凉悲伤）一个老外教的，要把第三音向上翻阅八度，然后前三个注释和弦都补充最后一个和弦的最高音</li>
      <li>G D A B （G调的小忧伤）：三音上翻八度，前两个小节温馨温暖，后两个小节突然忧伤</li>
    </ul>
    <h2>古典/流行</h2>
    <ul>
    ...
    <h2>影视/史诗乐/系列</h2>
    <ul>
      <li>《盗梦空间》：[2（向下转位1）-6（三级音上八度）-1-5（中上八度）]-[24（中替3上八度）15]，整个从C升成G调</li>
    ...
    <ul>
      ...
      <li>不同的套路和弦之间可以进行东拼西凑，比如卡农进行和经典流行进行拼接</li>
    </ul>
  </div>
</template>
...
export default {
  data() {
    return {
      chords: [
        { id: 1, englishName: "Major", chineseName: "大三和弦", feel: "明亮/开心" },
