...
const keyToNote = ref<Record<string, Note>>({
  // 第一行
  "Q": Note.fromNoteName('C4'),
  "W": Note.fromNoteName('D4'),
  "E": Note.fromNoteName('E4'),
  "R": Note.fromNoteName('F4'),
  "T": Note.fromNoteName('G4'),
  "Y": Note.fromNoteName('A4'),
  "U": Note.fromNoteName('B4'),
  // 第二行
  "A": Note.fromNoteName('C3'),
  "S": Note.fromNoteName('D3'),
  "D": Note.fromNoteName('E3'),
  "F": Note.fromNoteName('F3'),
  "G": Note.fromNoteName('G3'),
  "H": Note.fromNoteName('A3'),
  "J": Note.fromNoteName('B3'),
  // 第三行
  "Z": Note.fromNoteName('C2'),
  "X": Note.fromNoteName('D2'),
  "C": Note.fromNoteName('E2'),
  "V": Note.fromNoteName('F2'),
  "B": Note.fromNoteName('G2'),
  "N": Note.fromNoteName('A2'),
  "M": Note.fromNoteName('B2'),
});
